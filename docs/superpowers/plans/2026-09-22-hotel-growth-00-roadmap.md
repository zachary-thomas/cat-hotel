...
| 04/T5 | 833151f, 49ededa | Approved after review found lower-floor rooms/objects/cats were selectable through an empty upstairs hall. Floor-aware sorted ray picks and a red/green real mouse-release player check fixed it. Stacked-floor, roof and basement captures inspected; isolated Unity EditMode 80/80. |
