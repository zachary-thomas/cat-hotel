...
| Creative model, content, building, maps, save integrity, services, God mode, social simulation, world, UI, app and dense-property suites | All 12 suites completed with zero failures |
| Actual UI captures | 55 original captures at the five required sizes plus 12 God mode Settings/Build captures at 360×640, 390×844 and 1280×800; zero layout failures at 100% and 150% text |
...
|---|---:|
| Cached simulation, 3,600 frames | Approximately 0.15–0.19 ms per frame |
| Build quote | Approximately 25–32 ms |
| Initial navigation build | Approximately 69–106 ms |
| Save validation | Approximately 0.4–0.56 seconds |
| Rendered property, 1280×800, 90 measured frames | 4.12 ms per frame |
| Draw calls in rendered dense view | 2,912 |
