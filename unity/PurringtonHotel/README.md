...
- Income and arrivals use a simplified ready-room model, not full Godot economy/capacity parity. Domain construction now covers land plots, earth/gravel/brick paths, room copy/resize/move/remove, furnished templates, catalogue placement, storage, and God mode (see tests/unity-domain ConstructionSuites); presentation polish and visual/input evidence remain open.
