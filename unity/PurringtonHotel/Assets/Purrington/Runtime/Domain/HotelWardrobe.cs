...
public sealed class WearDefinition {public string id,name,slot,quest;public double price;public int giftCat=-1,giftBond=50;public JArray parts=new JArray();}
