...
[Serializable] public sealed class HotelState {
 public int version=2; public double coins=1000; public float elapsed; public int nextId=1,currentHotel; public long lastSeen; public double pendingCoins;
