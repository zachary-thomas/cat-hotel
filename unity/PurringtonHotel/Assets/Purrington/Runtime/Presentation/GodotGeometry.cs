...
public sealed class GodotGeometry : IDisposable {
 ...
 Transform BuildAffine(Transform parent,JObject recipe,Dictionary<string,Transform> bindings,Matrix4x4 carry) {
  ...
  foreach(var child in recipe["children"]??new JArray())BuildAffine(t,(JObject)child,bindings,residual);return t;
 }
 ...
 public void Dispose(){foreach(var m in materials.Values)UnityEngine.Object.Destroy(m);foreach(var m in meshes.Values)UnityEngine.Object.Destroy(m);}
}
