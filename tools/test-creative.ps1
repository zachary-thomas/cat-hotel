...
try {
    ...
    if (-not $Suites) { $Suites=@('test_creative_content','test_creative_model','test_creative_building','test_creative_maps_integration','test_creative_save_integrity','test_creative_services','test_creative_god_mode','test_creative_social','test_creative_movement','test_creative_meadow','test_creative_world','test_creative_voxel_polish','test_creative_ui','test_creative_app','test_creative_dense') }
