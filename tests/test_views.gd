...
func run() -> void:
	...
	check(world.exterior_view and shell.exterior.visible and app.ui.view_button.text == "Inside","The view button shows the complete hotel and offers a return inside")
